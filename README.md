...
cpvp-pro/
├── assets/
│   └── readme-banner.svg   # баннер для README
...
├── CONTRIBUTING.md         # правила изменений в репозитории
├── README.md               # описание проекта
└── index.html              # текущая production landing page
```
...
- [x] Добавить базовое оформление репозитория
